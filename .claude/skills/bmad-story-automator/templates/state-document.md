...
agentConfig:
  defaultPrimary: "omp"       # omp/pi -> Oh My Pi (omp --auto-approve); auto resolves to runtime provider; claude | codex | pi | omp
  defaultFallback: false      # Default fallback: claude | codex | pi | false (disabled)
