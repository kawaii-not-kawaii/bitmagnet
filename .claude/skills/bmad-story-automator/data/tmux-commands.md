...
| Variable | Claude | Codex | Pi (OMP) |
| CLI | `claude --dangerously-skip-permissions` | `codex exec --full-auto` | `omp --auto-approve` |
| Prompt Style | Natural language skill prompt | Natural language skill prompt | Natural language skill prompt |
| Timeout Multiplier | 1x (60min) | 1.5x (90min) | 1x (60min) |
| Todo Tracking | ☒/☐ checkboxes | Not supported | ☒/☐ checkboxes |

**Environment Variables:**
- `AI_AGENT` = `claude`, `codex`, or `pi` (used by story-automator tmux-wrapper and story-automator monitor-session)
