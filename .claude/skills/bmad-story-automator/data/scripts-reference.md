...
|------|-------------|---------------|
| `create` | Create story from epic | Claude, Codex, Pi |
| `dev` | Implement story tasks | Claude, Codex, Pi |
| `auto` | Test automation | Claude, Codex, Pi |
| `review` | Code review with auto-fix | Claude, Codex, Pi |
| `retro` | Retrospective (YOLO mode) | Claude, Codex, Pi |
